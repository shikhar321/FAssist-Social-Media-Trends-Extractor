    ...
    (async () => {
        ...
        var frameResult = async function () {
            try {
                ...
                const data = await T.get('/search/tweets', { tweet_mode: "extended", include_entities: "true", q: "fashion min_replies:100 min_faves:500 min_retweets:500", count: 100 });
                let pos = 1 ; 
        ...
        return response.render("top-tweets", {
            ...
            title: "Top Tweets Fashion| FAssist"
        });
